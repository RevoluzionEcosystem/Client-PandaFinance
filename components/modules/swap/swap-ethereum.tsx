                        ...
                        <div className="w-2/3 min-w-[50%] max-w-[36rem]">
                            ...
                            {tradeData.map((item, index) => (
                                <div className="grid grid-cols-[1fr_1fr_auto] text-sm p-2 border border-muted rounded-md my-2">
                                    ...
                                    <Button className="my-auto" variant="primary" key={`button-${index}`} onClick={chain.id !== chains[0].id ? () => switchNetwork?.(chains[0].id) : () => trade(item.index)}>
                                        {chain.id !== chains[0].id ? terms.switch_network : terms.trade}
                                    </Button>
                                </div>
                            ))}
                        </div>
