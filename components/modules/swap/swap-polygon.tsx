...
export default function SwapPolygon() {
    ...
    return (
        <TabsContent value="polygon">
            <Card>
                <CardHeader>
                    <CardTitle>
                        {`${swap["content"]["polygon"].headline}`}
                    </CardTitle>
                    <CardDescription>
                        {`${swap["content"]["polygon"].subheadline}.`}
                    </CardDescription>
                </CardHeader>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent>
                                                <SelectGroup>
                                                    ...
                                                    {whitelist["polygon"]["from"].map((item, index) => (
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent>
                                                <SelectGroup>
                                                    ...
                                                    {whitelist["polygon"]["to"].map((item, index) => (
                                                        <SelectItem key={index} value={item.value}>
                                                            {item.title}
                                                        </SelectItem>
                                                    ))}
